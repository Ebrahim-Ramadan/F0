        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="flex flex-col-reverse md:flex-row items-center justify-between text-center md:text-left">
            ...
            <div className="w-full md:w-1/2 space-y-3 md:space-y-4">
              <div className="inline-block rounded-lg transition-all duration-300 hover:bg-primary-200 bg-primary-100 px-3 py-1 text-sm font-bold flex w-fit gap-1 flex-row">
                Inspired by 
