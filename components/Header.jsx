...
export const Header = () => {
  return (
   ...
   <div className="p-2 z-30 mx-auto flex max-w-7xl items-center justify-between bg-transparent">
      ...
      <nav className=" gap-1 flex items-center text-[#006B78] bg-primary-900 backdrop-blur-3xl px-2 py-1 rounded-xl">
        ...
        <span className='text-xs font-bold'>Welcome</span>
      </nav>
      <a href='https://github.com/Ebrahim-Ramadan/nextjs-picthing-indie' target='_blank' className='bg-white rounded-full p-1 flex flex-row items-center gap-2'>
