...
export const Footer = () => {
  return (
<footer className="bg-gradient-to-b from-transparent to-primary-100 text-white py-12 px-4 sm:px-6 ">
...
F0              
        ...
        />
        <button className="truncate bg-blue-500 hover:bg-blue-600 text-white px-2 md:px-4 py-2 rounded-xl text-sm md:text-base">
          Subscribe
        </button>
      </div>
            <p className="text-sm text-primary-700">Join 100,000+ satisfied customers today!</p>
          </div>
        </div>
        <div className="mt-8 pt-8 border-t border-primary-300 flex w-full md:justify-between justify-center flex-col md:flex-row items-center">
          ...
          <div className="flex space-x-4 mt-4 sm:mt-0">
            <Link
            href="https://github.com/Ebrahim-Ramadan/f0" target='_blank' className="text-sm bg-primary-200 hover:bg-primary-300 transition-colors rounded-full p-2 ">
              <GithubIcon size={20} fill='#CCCCCC' strokeWidth={0} />
            </Link>
            <Link
            href="https://x.com/scoopsahoykid" target='_blank' className="text-sm bg-primary-200 hover:bg-primary-300 transition-colors rounded-full p-2 ">
